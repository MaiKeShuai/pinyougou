...
public class GoodsDescServiceImpl implements GoodsDescService {
     ...
     */
    @Override
    public PageInfo<TbGoodsDesc> findPage(int pageNum, int pageSize) {
        PageHelper.startPage(pageNum, pageSize);
        List<TbGoodsDesc> list = goodsDescMapper.selectByExample(null);
        return new PageInfo<TbGoodsDesc>(list);
    }
    ...
    @Override
    public PageInfo<TbGoodsDesc> findPage(TbGoodsDesc goodsDesc, int pageNum, int pageSize) {
        PageHelper.startPage(pageNum, pageSize);
