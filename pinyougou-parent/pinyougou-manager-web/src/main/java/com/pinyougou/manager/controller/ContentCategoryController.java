...
public class ContentCategoryController {
	...
	public PageInfo<TbContentCategory> findPage(int page, int rows){
	...
	public PageInfo<TbContentCategory> search(@RequestBody TbContentCategory contentCategory, int page, int rows  ){
