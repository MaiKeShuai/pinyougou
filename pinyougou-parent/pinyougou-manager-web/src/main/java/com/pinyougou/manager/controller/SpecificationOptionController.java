...
public class SpecificationOptionController {
	...
	public PageInfo<TbSpecificationOption> findPage(int page, int rows){
	...
	public PageInfo<TbSpecificationOption> search(@RequestBody TbSpecificationOption specificationOption, int page, int rows  ){
